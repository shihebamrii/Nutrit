    ...
    <div class="invoice-container">
        <div class="invoice-header">
            <div class="brand">
                ...
                <p style="color: var(--gray-600); margin: 0.5rem 0 0 0;">
                    123 Healthy Way<br>
                    Wellness City, TN 1000
                </p>
            </div>
            <div class="invoice-title">
                <h1>FACTURE</h1>
                <p style="color: var(--gray-600); margin: 0.5rem 0 0 0;">
                    N° : <%= invoice != null ? invoice.getInvoiceNumber() : "BROUILLON" %><br>
        ...
        <table class="table">
            <thead>
                <tr>
                    <th>Description</th>
                    <th style="width: 100px; text-align: center;">Heures</th>
            ...
            <tbody>
                <tr>
                    <td>
                        <strong>Consultation Nutrition</strong><br>
                    ...
                    <td style="text-align: right;">
                        <%= invoice != null ? invoice.getAmount() : (appt.getPaymentAmount() != null ? appt.getPaymentAmount() : "50.00") %> TND
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="total-section">
            <div class="total-box">
                <div class="total-row">
                    ...
                    <span><%= invoice != null ? invoice.getAmount() : (appt.getPaymentAmount() != null ? appt.getPaymentAmount() : "50.00") %> TND</span>
                </div>
                <div class="total-row">
                    <span>TVA (0%) :</span>
                    <span>0.00 TND</span>
        ...
        <div style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid var(--gray-200);">
            <p style="color: var(--gray-600); font-size: 0.875rem;">
                <strong>Modalités de Paiement :</strong> Paiement reçu via <%= invoice != null && "online".equals(invoice.getPaymentMethod()) ? "Paiement en ligne" : "Paiement au cabinet" %>.
                <br>Merci d'avoir choisi Nutrit pour votre parcours santé.
            </p>
        </div>
